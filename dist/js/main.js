...
/***/ "./src/blocks/components/projects-grid/projects-grid.js":
/*!**************************************************************!*\
  !*** ./src/blocks/components/projects-grid/projects-grid.js ***!
  \**************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
document.addEventListener("DOMContentLoaded", function () {
  if (window.innerWidth <= 768) {
    var projectsGrids = document.querySelectorAll(".projects-grid");
    projectsGrids.forEach(function (projectsGrid, i) {
      projectsGrid.classList.add("swiper-".concat(i));
      projectsGrid.querySelector(".projects-grid__wrapper").classList.add("swiper-wrapper");
      projectsGrid.querySelectorAll(".projects-grid__project").forEach(function (project) {
        project.classList.add("projects-grid__project--mobile", "swiper-slide");
      });
      var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".projects-grid.swiper-".concat(i), {});
      projectsGrid.querySelectorAll(".projects-grid__btn").forEach(function (btn) {
        btn.addEventListener("click", function () {
          if (btn.classList.contains("projects-grid__btn--next")) {
            swiper.slideNext();
          }
          if (btn.classList.contains("projects-grid__btn--prev")) {
            swiper.slidePrev();
          }
        });
      });
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  tabsBlocks.forEach(function (tabsBlock) {
    var tabs = tabsBlock.querySelectorAll(".tabs__tab");
    var tabContents = tabsBlock.querySelectorAll(".tabs__tab-content");
    tabs.forEach(function (tab) {
      tab.classList.remove("tabs__tab--active");
    });
    tabContents.forEach(function (tabContent) {
      tabContent.classList.remove("tabs__tab-content--active");
    });
    tabs[0].classList.add("tabs__tab--active");
    tabContents[0].classList.add("tabs__tab-content--active");
    tabs.forEach(function (tab, i) {
      tab.addEventListener("click", function (event) {
        ...
        tabContents[i].classList.add("tabs__tab-content--active");
      });
    });
  });
});
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var mobileMenuButton = header.querySelector(".header__btn--mobile");
  var mobileMenu = document.querySelector(".menu-mobile");
  mobileMenuButton.addEventListener("click", toggleMobileMenu);
  function toggleMobileMenu() {
    mobileMenu.classList.toggle("menu-mobile--active");
    document.body.style.overflow = mobileMenu.classList.contains("menu-mobile--active") ? "hidden" : "auto";
    updateMobileMenuIcon();
  }
  function updateMobileMenuIcon() {
    var iconUseElement = mobileMenuButton.querySelector("svg use");
    var iconId = mobileMenu.classList.contains("menu-mobile--active") ? "#burger-close" : "#burger-open";
    iconUseElement.setAttribute("xlink:href", "img/sprites/sprite.svg".concat(iconId));
  }
});

/***/ }),

/***/ "./src/blocks/modules/practices/practices.js":
/*!***************************************************!*\
  !*** ./src/blocks/modules/practices/practices.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
document.addEventListener("DOMContentLoaded", function () {
  var addTabsSwiper = function addTabsSwiper(parentClass) {
    if (window.innerWidth <= 1024) {
      var tabContents = document.querySelectorAll("".concat(parentClass, " .tabs .tabs__tab-content"));
      tabContents.forEach(function (tabContent, i) {
        ...
        var cols = tabContent.querySelectorAll(".tabs__col");
        swiperBlock.className = "swiper-wrapper";
        tabContent.insertBefore(swiperBlock, tabContent.querySelector(".tabs__btns"));
        cols.forEach(function (col) {
          col.classList.add("swiper-slide");
          swiperBlock.append(col);
        });
        var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]("".concat(parentClass, " .swiper-").concat(i), {
          slidesPerView: 1,
          breakpoints: {
            600: {
              slidesPerView: 2
        ...
        tabContent.querySelectorAll(".tabs__btn").forEach(function (btn) {
          btn.addEventListener("click", function () {
            if (btn.classList.contains("tabs__btn--next")) {
              swiper.slideNext();
            }
            if (btn.classList.contains("tabs__btn--prev")) {
              swiper.slidePrev();
            }
          });
        });
  ...
  addTabsSwiper(".header");
  addTabsSwiper(".practices");
});
...
/* harmony import */ var _components_tabs_tabs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! %components%/tabs/tabs */ "./src/blocks/components/tabs/tabs.js");
/* harmony import */ var _components_tabs_tabs__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_components_tabs_tabs__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _components_projects_grid_projects_grid__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! %components%/projects-grid/projects-grid */ "./src/blocks/components/projects-grid/projects-grid.js");
...
/* harmony import */ var _modules_practices_practices__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! %modules%/practices/practices */ "./src/blocks/modules/practices/practices.js");
...
/* harmony import */ var _modules_projects_projects__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_modules_projects_projects__WEBPACK_IMPORTED_MODULE_3__);
